...
export default function FacultyDelete(
    ...
    const studentShowDelete = studentList.filter(i => id.includes(i.group.department.faculty.id))
    ...
    return (
        <div className='p-4'>
            ...
            <span className='is-size-5'>
                <br/>
                <span className="ml-5">📍 Faculties: {studentShowDelete.length}</span>
                <br/>
            ...
            {studentShowDelete.map((item) => (
                <div key={item.id}>
                    <div className='is-flex'>
                        <span className='is-size-5 ml-5 is-flex'> 📍 Faculty: </span>
                        <span className='ml-3 is-size-5 has-text-danger'>{item.group.department.faculty.name}</span>
                    </div>
